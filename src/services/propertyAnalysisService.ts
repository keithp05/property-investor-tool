...
class PropertyAnalysisService {
  ...
  async generateCMAReport(property: any): Promise<CMAReport> {
    ...
    const dealInputs: DealInputs = {
      ...
      reserveCost: property.reserveCost || 5000, // Default $5,000 reserve
      downPaymentPercent: property.downPaymentPercent || 20,
      interestRate: property.interestRate || 7.5,
      loanTermYears: property.loanTermYears || 30,
      closingCosts: property.closingCosts || (property.purchasePrice || estimatedValue) * 0.03,
